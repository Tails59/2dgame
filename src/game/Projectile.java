...
/**
 * A projectile, those fast-moving fireballs you see when you shoot or when you
 * get shot at.
 * 
 * @author Taylor Paige
 *
...
public class Projectile extends Sprite implements UpdateableSprite, RenderedSprite {
	...
	private boolean hasHit() {
		return (this.left && Collision.checkLeftTileCollision(this)) || (Collision.checkRightTileCollision(this))
				|| (Collision.checkSpriteCollision(this, Enemy.getEnemies()))
				|| (Collision.checkSpriteCollision(this, Driver.dr.getPlayer()));
	}

	/**
	 * Destroy the projectile, do an small explosion animation then unrender itself
	 */
